...
const LoginView = () => {
  return (
    <div className="w-full h-screen min-h-full winid-gradient-logo flex flex-col items-center justify-center">
      <h1 className="mb-1 text-2xl text-white font-winid1 uppercase">
        <span className="text-winid-1">Winid</span>U to Login
      </h1>
