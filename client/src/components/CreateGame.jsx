...
const CreateGameForm = props => {
  ...
  return (
    <Form onSubmit={handleSubmit} layout="inline" className="flex justify-between align-center">
      ...
      <Form.Item label="DatePicker">{getFieldDecorator("datePicker")(<DatePicker className="w-full" />)}</Form.Item>
      <Form.Item label="TimePicker">
        {getFieldDecorator("timePicker")(<TimePicker format={"HH:mm"} className="w-full" />)}
      </Form.Item>
